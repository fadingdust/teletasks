...
public sealed class TelegramBotService : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        // Notifier loop now lives in JobNotifierService (separate hosted
        // service, registered alongside this one). This service stays alive
        // to own the IChatProvider lifecycle + OnMessage subscription;
        // message handling fires on the provider's callback thread.
